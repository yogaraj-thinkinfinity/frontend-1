...
numbers.slice(2,5)  // .slice( startIndex, endIndex)    copies element from startIndex 
                                        //  till endIndex without including endIndex
numbers.splice(3,6) // .splice(startIndex, number_of_elements_to_be_removed)    
                                    // cuts element from startIndex and removes totally 10 from array
